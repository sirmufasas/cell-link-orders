...
// New-order sound alert preference. The actual siren + shouted-voice sound
// lives in src/lib/alertSound.ts, shared with the customer-facing
// "orders closing soon" reminders so both sound identical.
